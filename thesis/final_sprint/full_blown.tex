...
(2007: 178). To that end I have deemed it important to begin at
\quotation{a basis} of digital process as it stands today.
Computers have multiplexed dependencies. The hardware is virtually
non-functional without an operating system. Likewise operating
systems, like all software, are non-functional, even
\quotation{non-existent,} without the presence of hardware. As the
coded substrate for software, the operating system provides the
sites of intersection between human and digital process.

\section{Alan Kay and a `Metamedium´ Vision for Personal Computing}
...
\subsubsection{Operating Systems as the Substrates of Contemporary Design}
...
The crucial separation here is not between the computer
...
\section{Design Beyond the Proprietary}
...
\subsection{Traditional Design Interfaces in FLoSS}
...
\subsubsubsection{Software Time}
...
\subsection{Remediation and the Command Line}
...
widely used than formal formats such as TeX (and LaTeX/ConTeXt).
...
TeX, on the other hand, is not simply a format. The kinetic language, denoted
by keywords beginning with an \quote{\type{\}}, is literally compiled
into the raw data of the PDF format. Because this raw data fits the PDF
standard, any PDF browser should be able to view the resulting output.
This is a bottom up approach in that the markup of TeX itself does
not allow the plain text document to be rendered differently according
to which interface is used (as an HTML file will look different according
to whether it was opened in a text editor or a browser). Rather, TeX markup
is a language of assembly.
...
Even though a process has the appearance of objectivity, we realize
the fact that it stems from subjective intentions.
\stopdescr
...
A clear and logical setting emphasizes that which does not seem to
fit within it.
...
Input should come from our external and complex environment:
nature, society and its human interactions.
\stopdescr
...
This argument is easily extended, as will be demonstrated in the final
draft of this thesis. An easy mechanism is the importation of Robert Bringhurst's
typographic grammars into the typesetting of the HTML output. By first
applying the term remediation to this process, I will demonstrate how
such an application is invalid and could better be understood as an
appropriation of grammar.

Lev Manovich's \quote{media hybridity} will also be complicated by
its inapplicability in the context of describing this generative workflow
of typesetting.
...
\quotation{Dear Browser, treat this as a header of level 1.}
...
\useURL[6][http://www.salon.com/technology/apple/index.html?story=/tech/dan_gillmor/2010/06/20/from_mac_to_linux][][http://www.salon.com/technology/apple/index.html?story=/tech/dan\letterunderscore{}gillmor/2010/06/20/from\letterunderscore{}mac\letterunderscore{}to\letterunderscore{}linux]\from[6]
(last accessed 21 June 2010).

Hagen, Hans. (2009). {\em The history of luaTeX}. Netherlands:
Pragma ADE. Web.
\letterless{}\useURL[7][http://www.pragma-ade.com/general/manuals/mk.pdf][][http://www.pragma-ade.com/general/manuals/mk.pdf]\from[7]\lettermore{}
(last accessed 5 June 2010).
...
\letterless{}\useURL[8][http://google-opensource.blogspot.com/2010/06/introducing-google-command-line-tool.html][][http://google-opensource.blogspot.com/2010/06/introducing-google-command-line-tool.html]\from[8]\lettermore{}
...
\letterless{}\useURL[9][http://www.newmediareader.com/book_samples/nmr-26-kay.pdf][][http://www.newmediareader.com/book\letterunderscore{}samples/nmr--26-kay.pdf]\from[9]\lettermore{}
(last accessed 15 June 2010).

{\em Kernel (computing)}. (2010). \quotation{Kernel (computing)}.
{\em Wikipedia}. Web.
\letterless{}[http://en.wikipedia.org/wiki/Kernel{\em \%28computing\%29](http://en.wikipedia.org/wiki/Kernel}\%28computing\%29)\lettermore{}
(last accessed 18 June 2010).
...
\letterless{}\useURL[10][http://ctheory.net/articles.aspx?id=633][][http://ctheory.net/articles.aspx?id=633]\from[10]\lettermore{}
...
\letterless{}\useURL[11][http://journal.fibreculture.org/issue14/issue14_langlois_et_al.html][][http://journal.fibreculture.org/issue14/issue14\letterunderscore{}langlois\letterunderscore{}et\letterunderscore{}al.html]\from[11]\lettermore{}
...
\letterless{}\useURL[12][http://softwarestudies.com/softbook/manovich_softbook_11_20_2008.doc][][http://softwarestudies.com/softbook/manovich\letterunderscore{}softbook\letterunderscore{}11\letterunderscore{}20\letterunderscore{}2008.doc]\from[12]\lettermore{}
(

Marco, Meg. (2010).
\quotation{Privacy Change: Apple Knows Where Your Phon Is and Is Telling People}.
{\em The Consumerist}. 21 June 2010. Wev.
\letterless{}\useURL[13][http://consumerist.com/2010/06/privacy-change-apple-knows-your-phone-is-and-is-telling-people.html][][http://consumerist.com/2010/06/privacy-change-apple-knows-your-phone-is-and-is-telling-people.html]\from[13]\lettermore{}
...
\letterless{}\useURL[14][http://www.conditionaldesign.org/manifesto/][][http://www.conditionaldesign.org/manifesto/]\from[14]\lettermore{}
...
\letterless{}\useURL[15][http://www.generation-online.org/c/fc_rent4.pdf][][http://www.generation-online.org/c/fc\letterunderscore{}rent4.pdf]\from[15]\lettermore{}
...
\letterless{}\useURL[16][http://www.parrhesiajournal.org/parrhesia07/parrhesia07_simondon1.pdf][][http://www.parrhesiajournal.org/parrhesia07/parrhesia07\letterunderscore{}simondon1.pdf]\from[16]\lettermore{}
(last accessed 5 June 2010).

Snelting, Femke. (2009). \quotation{The Making of}.
{\em Tracks in electr(on)ic fields}. Brussels: Constant. Web.
\useURL[17][http://ospublish.constantvzw.org/wp-content/uploads/makingof.pdf][][http://ospublish.constantvzw.org/wp-content/uploads/makingof.pdf]\from[17]
(last accessed 5 June 2010).
...
PDF.
\letterless{}[http://web.mit.edu/\low{simsong/www/ugh.pdf](http://web.mit.edu/}simsong/www/ugh.pdf)\lettermore{}.

{\em Windows 1.0}. (2010). \quotation{Windows 1.0}.
{\em Wikipedia}. Web.
\letterless{}\useURL[19][http://en.wikipedia.org/wiki/Windows_1.0][][http://en.wikipedia.org/wiki/Windows\letterunderscore{}1.0]\from[19]\lettermore{}
(last accessed 19 June 2010).

{\em Windows XP}. (2010). \quotation{Windows XP}. {\em Wikipedia}.
Web.
\letterless{}\useURL[20][http://en.wikipedia.org/wiki/Windows_xp][][http://en.wikipedia.org/wiki/Windows\letterunderscore{}xp]\from[20]\lettermore{}
(last accessed 19 June 2010).

{\em XNU}. (2010). \quotation{XNU}. {\em Wikipedia}. Web.
\letterless{}\useURL[21][http://en.wikipedia.org/wiki/XNU][][http://en.wikipedia.org/wiki/XNU]\from[21]\lettermore{}
(last accessed 18 June 2010).
