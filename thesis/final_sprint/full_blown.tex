...
\setupinterlinespace[line=1.5em] % should be 3/2 spacing

\setupindenting[medium]
\indenting[always]

\setuphead[section][style=\sc]
\setuphead[subsection][style=\sc]
...
\section{Substrates of Digital Process}
...
\section{Constraints: Generative Design in FLoSS}
...
\section{Crystalized Process: Text That Typesets Itself}
...
\quotation{the space of electronic writing.}[\letterhat{}second] In
defining this space as
