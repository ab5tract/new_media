...
\placefigure[here,nonumber]{Individuation of the Unix processual grammar over time. Image provided by WikiMedia.}{\externalfigure[images/unix_history.png]}
...
\placefigure[here,nonumber]{The architecture of Mac OS X. Note the hybridization of BSD and Mach within the kernel section of the diagram. Image courtesy of WikiMedia.}{\externalfigure[images/os_x_architecture.png]}
...
\placefigure[here,nonumber]{The Textroom editor running in full-screen mode.}{\externalfigure[images/textroom.png]}
...
\placefigure[here,nonumber]{The file \quote{bibliography.md} is automatically rendered through the web interface of github.com, where it is stored in a version control repository.}{\externalfigure[images/github-bib.png]}
