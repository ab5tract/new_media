...
function ajaxTagCloud(type,tool){
		...
		if(el) el.innerHTML = "<img src='/~erik/tools/beta/scripts/ajax-loader.gif' style='margin-top:20px; margin-left:100px'>";
		currentType = type;
		currentTool = tool;
...
function queryHandler(id,type,ordered,resultfile) {
	var dataSource = 'http://lab.digitalmethods.net/~erik/tools/beta/generic/tagCloud.php?type=' + type + '&ordered=' + ordered + '&url=' + resultfile;
